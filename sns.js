...
exports.SNS_TOPIC_ARN = process.env.SNS_TOPIC_ARN || ""; // Use the SNS Topic ARN from .env
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                params = {
                    Message: message,
                    TopicArn: exports.SNS_TOPIC_ARN,
                };
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, exports.sns.publish(params).promise()];
            case 2:
                _a.sent();
